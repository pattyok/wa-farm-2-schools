 ...
 * * `wa_farm_2_schools()->is_primary_nav_menu_active()`
 * * `wa_farm_2_schools()->display_primary_nav_menu( array $args = [] )`
 */
class Component implements Component_Interface, Templating_Component_Interface {
	...
	public function action_register_nav_menus() {
		register_nav_menus(
			array(
				static::PRIMARY_NAV_MENU_SLUG   => esc_html__( 'Primary', 'wa-farm-2-schools' ),
				static::SECONDARY_NAV_MENU_SLUG => esc_html__( 'Secondary', 'wa-farm-2-schools' ),
			)
		);
	}
