 ...
 * * `wa_farm_2_schools()->is_primary_sidebar_active()`
 * * `wa_farm_2_schools()->display_primary_sidebar()`
 *
...
class Component implements Component_Interface, Templating_Component_Interface {
	...
	public function action_register_sidebars() {
		register_sidebar(
			array(
				'name'          => esc_html__( 'Header Top', 'wa-farm-2-schools' ),
				'id'            => 'header-top',
				'description'   => esc_html__( 'Place header content that will display above the nav tablet and up.', 'wa-farm-2-schools' ),
