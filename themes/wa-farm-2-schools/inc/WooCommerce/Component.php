...
class Component implements Component_Interface, Templating_Component_Interface {
	...
	public function initialize() {
		add_filter( 'wa_farm_2_schools_js_files', array( $this, 'woocommerce_js_file' ) );
	...
	public function woocommerce_js_file( $js_files ) {
		if ( is_shop() || is_product_category() || is_product() || is_cart() ) {
			$js_files['wa-farm-2-schools-woocommerce'] = array(
				'file'         => 'woo.min.js',
	...
	public function woocommerce_register_sidebars() {
		register_sidebar(
			array(
				'name'          => esc_html__( 'Shop Page Footer', 'wa-farm-2-schools' ),
				'id'            => 'shop-page-footer',
				'description'   => esc_html__( 'Displayed on the shop page', 'wa-farm-2-schools' ),
