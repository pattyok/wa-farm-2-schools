...
(function ($) {
  function moveSearchMobile() {
    ...
    if ($(window).width() < 1025) {
      $('#before-navigation .before-navigation__inner').detach().prependTo('#primary-menu-container');
      $('#after-navigation .after-navigation__inner').detach().appendTo('#primary-menu-container');
      ...
      $('#primary-menu-container .after-navigation__inner').detach().prependTo('#after-navigation');
      $('#primary-menu-container .before-navigation__inner').detach().prependTo('#before-navigation');
    }
  }
  function hideSearch() {
